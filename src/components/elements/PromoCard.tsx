...
export function PromoCard() {
  return (
    <div className="bg-emerald-50 rounded-2xl p-6 mt-6 text-center flex flex-col items-center">
      ...
      <p className="font-semibold font-sans text-emerald-900 text-2xl mt-1 mb-1">
        Get 0% APR Options
      </p>
      <div className="w-[65%]">
      ...
      <Button
        ...
        className="w-full bg-emerald-900 font-sans hover:bg-emerald-800 text-white text-base md:text-lg lg:text-xl py-6 md:py-7 lg:py-8 rounded-xl"
      >
        See offers →
      </Button>
    </div>
