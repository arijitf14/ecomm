      ...
      <div className="w-full flex-grow flex flex-col justify-center items-center">
        <div className="w-full max-w-2xl flex flex-col items-center gap-6 px-4">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-base sm:text-lg text-emerald-900 max-w-md">
          ...
          <div className="flex justify-center gap-3">
            {otp.map((digit, index) => (
              <div
                key={index}
                className={`w-10 h-14 flex items-center justify-center rounded-xl text-2xl font-semibold border-2 ${
